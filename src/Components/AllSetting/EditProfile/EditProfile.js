            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <Input type="text" placeholder="Bio" className="input" />
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button className='input mt-2'>Confirm Email Address</button>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <Input type="checkbox" placeholder="Gender" className="suggestionsBox input" />
